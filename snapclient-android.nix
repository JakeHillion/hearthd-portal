...
#
# SSL/TLS is off for now: OpenSSL's kernel-TLS code doesn't cross-compile against
# bionic, and it's optional (BUILD_WITH_SSL). That means plain-TCP snapservers
# only — no wss:// or server auth yet.
{ pkgs }:
